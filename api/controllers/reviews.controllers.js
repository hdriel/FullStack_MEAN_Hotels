...
var _addReview = function (req, res, hotel) {
  console.log("_addReview " , req.body);
  hotel.reviews.push({
    name : req.body.name,
  ...
  hotel.save(function(err, hotelUpdated) {
    if (err) {
      console.log("_addReview err" , err);
      res
        .status(500)
        .json(err);
    } else {
      console.log("_addReview success" , hotelUpdated.reviews[hotelUpdated.reviews.length - 1]);
      res
        .status(200)
...
module.exports.reviewsAddOne = function(req, res) {
  ...
  Hotel
    ...
    .exec(function(err, doc) {
      ...
      if (doc) {
          console.log("HotelId founded! ", id);
